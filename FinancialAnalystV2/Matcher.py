...
# FEATURE 2 - Compare the revenue from 2013 and 2014
    
def compareRevenues(train):
    return None

# FEATURE 3 - Find the word "crisis"
    
def findWord(listOfLists):
    return [(re.search('crisis', row[0])) for row in listOfLists]
